...
#pragma mark - Init
- (id)initWithFrame:(CGRect)frame calendar:(NSCalendar *)calendar monthDisplay:(NSDate *)month
    dateSelected:(NSDate *)date showDayOff:(BOOL)showDayOff dayViewHeight:(CGFloat)height {
...
- (void)createUIWithFrame:(CGRect)frame {
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.infoView attribute:NSLayoutAttributeWidth
        relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeWidth multiplier:1 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.infoView attribute:NSLayoutAttributeHeight
        relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1
            constant:INFOVIEW_HEIGHT]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.infoView attribute:NSLayoutAttributeTop
        relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTop multiplier:1.0 constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.infoView attribute:NSLayoutAttributeLeading
        relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeading multiplier:1.0 constant:0.0]];
    [self.infoView addSubview:self.lbInfor];
    [self.lbInfor setTranslatesAutoresizingMaskIntoConstraints:NO];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.lbInfor attribute:NSLayoutAttributeTop
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeTop multiplier:1.0
            constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.lbInfor attribute:NSLayoutAttributeBottom
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeBottom multiplier:1.0
            constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.lbInfor attribute:NSLayoutAttributeLeading
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeLeading multiplier:1.0
            constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.lbInfor attribute:NSLayoutAttributeTrailing
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeTrailing multiplier:1.0
            constant:0.0]];
    ...
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnPreviousMonth
        attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.infoView
            attribute:NSLayoutAttributeTop multiplier:1.0 constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnPreviousMonth
        attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.infoView
            attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnPreviousMonth
        attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.infoView
            attribute:NSLayoutAttributeLeading multiplier:1.0 constant:0.0]];
    [self.btnPreviousMonth addConstraint:[NSLayoutConstraint constraintWithItem:self.btnPreviousMonth
        attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.btnPreviousMonth
            attribute:NSLayoutAttributeHeight multiplier:1.0 constant:0.0]];
    [self.btnNextMonth setTranslatesAutoresizingMaskIntoConstraints:NO];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnNextMonth attribute:NSLayoutAttributeTop
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeTop multiplier:1.0
            constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnNextMonth
        attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.infoView
            attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0.0]];
    [self.infoView addConstraint:[NSLayoutConstraint constraintWithItem:self.btnNextMonth
        attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.infoView
            attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:0.0]];
    [self.btnNextMonth addConstraint:[NSLayoutConstraint constraintWithItem:self.btnNextMonth
        attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.btnNextMonth
            attribute:NSLayoutAttributeHeight multiplier:1.0 constant:0.0]];
    //Create WeekView
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.weekView attribute:NSLayoutAttributeTop
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeBottom multiplier:1.0
            constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.weekView attribute:NSLayoutAttributeLeading
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeLeading multiplier:1.0
            constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.weekView attribute:NSLayoutAttributeTrailing
        relatedBy:NSLayoutRelationEqual toItem:self.infoView attribute:NSLayoutAttributeTrailing multiplier:1.0
            constant:0.0]];
    [self.weekView addConstraint:[NSLayoutConstraint constraintWithItem:self.weekView attribute:NSLayoutAttributeHeight
        relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1.0
            constant:WEEKVIEW_HEIGHT]];
...
- (void)addCalendarView {
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.containerView attribute:NSLayoutAttributeTop
        relatedBy:NSLayoutRelationEqual toItem:self.weekView attribute:NSLayoutAttributeBottom multiplier:1.0
            constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.containerView attribute:NSLayoutAttributeLeading
        relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeading multiplier:1.0 constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.containerView attribute:NSLayoutAttributeTrailing
        relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:0.0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.containerView attribute:NSLayoutAttributeBottom
    ...
    for (NSUInteger i=0; i<3; i++) {
        FMonthView *monthView = [[FMonthView alloc] initWithCalendar:self.calendar showDayOff:self.showDayOff
        ...
        [self.containerView addConstraint:[NSLayoutConstraint constraintWithItem:monthView
            attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.containerView
                attribute:NSLayoutAttributeTop multiplier:1.0 constant:0.0]];
        [self.containerView addConstraint:[NSLayoutConstraint constraintWithItem:monthView
            attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.containerView
                attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0.0]];
        [self.containerView addConstraint:[NSLayoutConstraint constraintWithItem:monthView
            attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.containerView
                attribute:NSLayoutAttributeLeading multiplier:1.0 constant:0.0]];
        [self.containerView addConstraint:[NSLayoutConstraint constraintWithItem:monthView
            attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.containerView
                attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:0.0]];
...
- (void)handelPan:(UIPanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateEnded) {
        if (self.monthView.frame.origin.x > (self.bounds.size.width / 3)
            || ([recognizer velocityInView:self].x > 600.0)) {
            [self handleSwipe:self.swipeRight];
        } else if (self.monthView.frame.origin.x < -(self.bounds.size.width / 3)
            || ([recognizer velocityInView:self].x < (-600.0))) {
...
-(void)handleSwipe:(UISwipeGestureRecognizer *)recognizer {
    ...
    if (recognizer.direction == UISwipeGestureRecognizerDirectionRight) {
        ...
        monthViewRemainFrame = firstFrame = CGRectMake(self.containerView.bounds.size.width, 0,
            self.containerView.bounds.size.width, self.containerView.bounds.size.height);
        secondFrame = CGRectMake(-self.containerView.bounds.size.width, 0, self.containerView.bounds.size.width,
